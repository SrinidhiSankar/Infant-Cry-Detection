...
def relieveHunger():
    send_email.send_email("Hunger")
    return
def relieveBurping():
    send_email.send_email("Burping")
    return
def relieveBellyPain():
    send_email.send_email("Belly Pain")
    return
def relieveDiscomfort():
    send_email.send_email("Discomfort")
    return
def relieveTired():
    # play_audio.play_audio("lullaby_goodnight.mp3")
    return
def relieveTemp():
    send_email.send_email("The Temperature")
    return	
def relieveScared():
